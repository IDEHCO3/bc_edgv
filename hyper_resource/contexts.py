...
def geometry_operations():
    dic = {}
    if len(dic) == 0:
        dic['area'] = Type_Called('area', None, float)
        dic['boundary'] = Type_Called('boundary', None, float)
        dic['buffer'] = Type_Called('buffer', [float], GEOSGeometry)
        dic['centroid'] = Type_Called('centroid', None, Point)
        dic['contains'] = Type_Called('contains', [GEOSGeometry], bool)
        dic['convex_hull'] = Type_Called('convex_hull', None, Polygon)
        dic['coord_seq'] = Type_Called('coord_seq', None, tuple)
        dic['coords'] = Type_Called('coords', None, tuple)
        dic['count'] = Type_Called('count', None, int)
        dic['crosses'] = Type_Called('crosses', [GEOSGeometry], bool)
        from django.contrib.gis.gdal import SpatialReference

        dic['crs'] = Type_Called('crs', None, SpatialReference)
        dic['difference'] = Type_Called('difference', [GEOSGeometry], GEOSGeometry)
        dic['dims'] = Type_Called('dims', None, int)
        dic['disjoint'] = Type_Called('disjoint', [GEOSGeometry], bool)
        dic['distance'] = Type_Called('distance', [GEOSGeometry], float)
        dic['empty'] = Type_Called('empty', None, bool)
        dic['envelope'] = Type_Called('envelope', None, GEOSGeometry)
        dic['equals'] = Type_Called('equals', [GEOSGeometry], bool)
        dic['equals_exact'] = Type_Called('equals_exact', [GEOSGeometry, float], bool)
        dic['ewkb'] = Type_Called('ewkb', None, str)
        dic['ewkt'] = Type_Called('ewkt', None, str)
        dic['extend'] = Type_Called('extend', None, tuple)
        dic['extent'] = Type_Called('extent', None, tuple)
        dic['geojson'] = Type_Called('geojson', None, str)
        dic['geom_type'] = Type_Called('geom_type', None, str)
        dic['geom_typeid'] = Type_Called('geom_typeid', None, int)
        dic['get_coords'] = Type_Called('get_coords', None, tuple)
        dic['get_srid'] = Type_Called('get_srid', None, str)
        dic['get_x'] = Type_Called('get_x', None, str)
        dic['get_y'] = Type_Called('get_y', None, str)
        dic['get_z'] = Type_Called('get_z', None, str)
        dic['has_cs'] = Type_Called('has_cs', None, bool)
        dic['hasz'] = Type_Called('hasz', None, bool)
        dic['hex'] = Type_Called('hex', None, str)
        dic['hexewkb'] = Type_Called('hexewkb', None, str)
        dic['index'] = Type_Called('index', None, int)
        ...
        dic['json'] = Type_Called('json', None, str)
        dic['kml'] = Type_Called('kml', None, str)
        dic['length'] = Type_Called('length', None, float)
        dic['normalize'] = Type_Called('normalize', [float], Point)
        dic['num_coords'] = Type_Called('num_coords', None, int)
        dic['num_geom'] = Type_Called('num_geom', None, int)
        dic['num_points'] = Type_Called('num_points', None, int)
        dic['ogr'] = Type_Called('ogr', None, OGRGeometry)
        dic['overlaps'] = Type_Called('overlaps', [GEOSGeometry], bool)
        dic['point_on_surface'] = Type_Called('point_on_surface', None, Point)
        #dic['pop'] = Type_Called('pop', None, tuple)
        #dic['prepared'] = Type_Called('prepared', None, PreparedGeometry)
        dic['relate'] = Type_Called('relate', [GEOSGeometry], str)
        dic['relate_pattern'] = Type_Called('relate_pattern', [GEOSGeometry, str], str)
        dic['ring'] = Type_Called('ring', None, bool)
        ...
        dic['simple'] = Type_Called('simple', None, bool)
        dic['simplify'] = Type_Called('simplify', [float, bool], GEOSGeometry)
        dic['srid'] = Type_Called('srid', None, int)
        dic['srs'] = Type_Called('srs', None, SpatialReference)
        ...
        #dic['tuple'] = Type_Called('tuple', None, tuple)
        ...
        dic['wkb'] = Type_Called('wkb', None, str)
        dic['wkt'] = Type_Called('wkt', None, str)
        dic['x'] = Type_Called('x', None, float)
        dic['y'] = Type_Called('y', None, float)
        dic['z'] = Type_Called('z', None, float)
        return dic
