...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^capitais/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.CapitalList.as_view(), name='capital_list_fn'),
    ...
    url(r'^trechos-ferroviarios/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TrechoFerroviarioList.as_view(), name='trecho_ferroviario_list_fn'),
    ...
    url(r'^trechos-hidroviarios/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TrechoHidroviarioList.as_view(), name='trecho_hidroviario_list_fn'),
    ...
    url(r'^outras-unidades-protegidas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.OutrasUnidProtegidasList.as_view(), name='outras_unid_protegidas_list_fn'),

    url(r'^outros-limites-oficiais/$', views.OutrosLimitesOficiaisList.as_view(), name='outros_limites_oficiais_list'),
    url(r'^outros-limites-oficiais/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.OutrosLimitesOficiaisList.as_view(), name='outros_limites_oficiais_list_fn'),

    url(r'^paises/$', views.PaisList.as_view(), name='pais_list'),
    url(r'^paises/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PaisList.as_view(), name='pais_list_fn'),

    url(r'^terras-indigenas/$', views.TerraIndigenaList.as_view(), name='terra_indigena_list'),
    url(r'^terras-indigenas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TerraIndigenaList.as_view(), name='terra_indigena_list_fn'),
    ...
    url(r'^unidades-de-conservacao-nao-snuc/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.UnidadeConservacaoNaoSnucList.as_view(), name='unidade_conservacao_nao_snuc_list'),

    url(r'^unidades-de-protecao-integral/$', views.UnidadeProtecaoIntegralList.as_view(), name='unidade_protecao_integral_list'),
    url(r'^unidades-de-protecao-integral/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.UnidadeProtecaoIntegralList.as_view(), name='unidade_protecao_integral_list'),

    url(r'^unidades-de-uso-sustentavel/$', views.UnidadeUsoSustentavelList.as_view(), name='unidade_uso_sustentavel_list'),
    url(r'^unidades-de-uso-sustentavel/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.UnidadeUsoSustentavelList.as_view(), name='unidade_uso_sustentavel_list'),
    ...
    url(r'^aglomerados-rurais-de-extensao-urbana/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.AglomeradoRuralDeExtensaoUrbanaList.as_view(), name='aglomerado_rural_de_extensao_urbana_list'),

    url(r'^aglomerados-rurais-isolado/$', views.AglomeradoRuralIsoladoList.as_view(), name='aglomerado_rural_isolado_list'),
    url(r'^aglomerados-rurais-isolado/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.AglomeradoRuralIsoladoList.as_view(), name='aglomerado_rural_isolado_list'),

    url(r'^areas-edificadas/$', views.AreaEdificadaList.as_view(), name='area_edificada_list'),
    url(r'^areas-edificadas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.AreaEdificadaList.as_view(), name='area_edificada_list'),

    url(r'^vilas/$', views.VilaList.as_view(), name='vila_list'),
    url(r'^vilas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.VilaList.as_view(), name='vila_list'),

    url(r'^curvas-batimetricas/$', views.CurvaBatimetricaList.as_view(), name='curva_batimetrica_list'),
    url(r'^curvas-batimetricas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.CurvaBatimetricaList.as_view(), name='curva_batimetrica_list'),
    ...
    url(r'^dunas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.DunaList.as_view(), name='duna_list'),
    ...
    url(r'^elementos-fisiografico-natural/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.ElementoFisiograficoNaturalList.as_view(), name='elemento_fisiografico_natural_list'),

    url(r'^picos/$', views.PicoList.as_view(), name='pico_list'),
    url(r'^picos/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PicoList.as_view(), name='pico_list'),

    url(r'^pontos-cotados-altimetricos/$', views.PontoCotadoAltimetricoList.as_view(), name='ponto_cotado_altimetrico_list'),
    url(r'^pontos-cotados-altimetricos/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PontoCotadoAltimetricoList.as_view(), name='ponto_cotado_altimetrico_list'),

    url(r'^pontos-cotados-batimetricos/$', views.PontoCotadoBatimetricoList.as_view(), name='ponto_cotado_batimetrico_list'),
    url(r'^pontos-cotados-batimetricos/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PontoCotadoBatimetricoList.as_view(), name='ponto_cotado_batimetrico_list'),

    url(r'^eclusas/$', views.EclusaList.as_view(), name='eclusa_list'),
    url(r'^eclusas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EclusaList.as_view(), name='eclusa_list'),

    url(r'^edificacoes-de-construcao-portuaria/$', views.EdifConstPortuariaList.as_view(), name='edif_const_portuaria_list'),
    url(r'^edificacoes-de-construcao-portuaria/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifConstPortuariaList.as_view(), name='edif_const_portuaria_list'),
    ...
    url(r'^edificacoes-de-construcao-aeroportuaria/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifConstrAeroportuariaList.as_view(), name='edif_const_aeroportuaria_list'),

    url(r'^edificacoes-metro-ferroviaria/$', views.EdifMetroFerroviariaList.as_view(), name='edif_metro_ferroviaria_list'),
    url(r'^edificacoes-metro-ferroviaria/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifMetroFerroviariaList.as_view(), name='edif_metro_ferroviaria_list'),

    url(r'^fundeadouros/$', views.FundeadouroList.as_view(), name='fundeadouro_list'),
    url(r'^fundeadouros/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.FundeadouroList.as_view(), name='fundeadouro_list'),

    url(r'^pistas-de-ponto-pouso/$', views.PistaPontoPousoList.as_view(), name='pista_ponto_pouso_list'),
    url(r'^pistas-de-ponto-pouso/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PistaPontoPousoList.as_view(), name='pista_ponto_pouso_list'),

    url(r'^pontes/$', views.PonteList.as_view(), name='ponte_list'),
    url(r'^pontes/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PonteList.as_view(), name='ponte_list'),

    url(r'^sinalizacaoes/$', views.SinalizacaoList.as_view(), name='sinalizacao_list'),
    url(r'^sinalizacaoes/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.SinalizacaoList.as_view(), name='sinalizacao_list'),

    url(r'^travessias/$', views.TravessiaList.as_view(), name='travessia_list'),
    url(r'^travessias/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TravessiaList.as_view(), name='travessia_list'),

    url(r'^trechos-dutos/$', views.TrechoDutoList.as_view(), name='trecho_duto_list'),
    url(r'^trechos-dutos/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TrechoDutoList.as_view(), name='trecho_duto_list'),

    url(r'^tuneis/$', views.TunelList.as_view(), name='tunel_list'),
    url(r'^tuneis/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TunelList.as_view(), name='tunel_list'),

    url(r'^brejos-e-pantanos/$', views.BrejoPantanoList.as_view(), name='brejo_pantano_list'),
    url(r'^brejos-e-pantanos/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.BrejoPantanoList.as_view(), name='brejo_pantano_list'),

    url(r'^mangues/$', views.MangueList.as_view(), name='mangue_list'),
    url(r'^mangues/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.MangueList.as_view(), name='mangue_list'),

    url(r'^vegetacoes-de-restinga/$', views.VegRestingaList.as_view(), name='veg_restinga_list'),
    url(r'^vegetacoes-de-restinga/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.VegRestingaList.as_view(), name='veg_restinga_list'),

    url(r'^edificacoes-publica-militar/$', views.EdifPubMilitarList.as_view(), name='edif_pub_militar_list'),
    url(r'^edificacoes-publica-militar/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifPubMilitarList.as_view(), name='edif_pub_militar_list'),

    url(r'^postos-fiscais/$', views.PostoFiscalList.as_view(), name='posto_fiscal_list'),
    url(r'^postos-fiscais/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PostoFiscalList.as_view(), name='posto_fiscal_list'),
    ...
    url(r'^edificacoes-agropecuarias-de-extracao-vegetal-e-pesca/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifAgropecExtVegetalPescaList.as_view(), name='edif_agropec_ext_vegetal_pesca_list'),

    url(r'^edificacoes-industrial/$', views.EdifIndustrialList.as_view(), name='edif_industrial_list'),
    url(r'^edificacoes-industrial/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifIndustrialList.as_view(), name='edif_industrial_list'),

    url(r'^extracoes-minerais/$', views.ExtMineralList.as_view(), name='ext_mineral_list'),
    url(r'^extracoes-minerais/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.ExtMineralList.as_view(), name='ext_mineral_list'),

    url(r'^edificacoes-religiosa/$', views.EdifReligiosaList.as_view(), name='edif_religiosa_list'),
    url(r'^edificacoes-religiosa/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EdifReligiosaList.as_view(), name='edif_religiosa_list'),
    ...
    url(r'^estacoes-geradoras-de-energia-eletrica/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.EstGeradEnergiaEletricaList.as_view(), name='est_gerad_energia_eletrica_list'),

    url(r'^hidreletricas/$', views.HidreletricaList.as_view(), name='hidreletrica_list'),
    url(r'^hidreletricas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.HidreletricaList.as_view(), name='hidreletrica_list'),

    url(r'^termeletricas/$', views.TermeletricaList.as_view(), name='termeletrica_list'),
    url(r'^termeletricas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TermeletricaList.as_view(), name='termeletrica_list'),

    url(r'^torres-de-energia/$', views.TorreEnergiaList.as_view(), name='torre_energia_list'),
    url(r'^torres-de-energia/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TorreEnergiaList.as_view(), name='torre_energia_list'),

    url(r'^bancos-de-areia/$', views.BancoAreiaList.as_view(), name='banco_areia_list'),
    url(r'^bancos-de-areia/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.BancoAreiaList.as_view(), name='banco_areia_list'),

    url(r'^barragens/$', views.BarragemList.as_view(), name='barragem_list'),
    url(r'^barragens/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.BarragemList.as_view(), name='barragem_list'),

    url(r'^corredeiras/$', views.CorredeiraList.as_view(), name='corredeira_list'),
    url(r'^corredeiras/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.CorredeiraList.as_view(), name='corredeira_list'),

    url(r'^fozes-maritima/$', views.FozMaritimaList.as_view(), name='foz_maritima_list'),
    url(r'^fozes-maritima/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.FozMaritimaList.as_view(), name='foz_maritima_list'),

    url(r'^ilhas/$', views.IlhaList.as_view(), name='ilha_list'),
    url(r'^ilhas/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.IlhaList.as_view(), name='ilha_list'),

    url(r'^massas-dagua/$', views.MassaDaguaList.as_view(), name='massa_dagua_list'),
    url(r'^massas-dagua/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.MassaDaguaList.as_view(), name='massa_dagua_list'),

    url(r'^quedas-dagua/$', views.QuedaDaguaList.as_view(), name='queda_dagua_list'),
    url(r'^quedas-dagua/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.QuedaDaguaList.as_view(), name='queda_dagua_list'),

    url(r'^recifes/$', views.RecifeList.as_view(), name='recife_list'),
    url(r'^recifes/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.RecifeList.as_view(), name='recife_list'),

    url(r'^rochas-em-agua/$', views.RochaEmAguaList.as_view(), name='rocha_em_agua_list'),
    url(r'^rochas-em-agua/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.RochaEmAguaList.as_view(), name='rocha_em_agua_list'),

    url(r'^sumidouros-vertedouros/$', views.SumidouroVertedouroList.as_view(), name='sumidouro_vertedouro_list'),
    url(r'^sumidouros-vertedouros/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.SumidouroVertedouroList.as_view(), name='sumidouro_vertedouro_list'),

    url(r'^terrenos-sujeito-a-inundacao/$', views.TerrenoSujeitoInundacaoList.as_view(), name='terreno_sujeito_inundacao_list'),
    url(r'^terrenos-sujeito-a-inundacao/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TerrenoSujeitoInundacaoList.as_view(), name='terreno_sujeito_inundacao_list'),

    url(r'^trechos-de-drenagem/$', views.TrechoDrenagemList.as_view(), name='trecho_drenagem_list'),
    url(r'^trechos-de-drenagem/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TrechoDrenagemList.as_view(), name='trecho_drenagem_list'),

    url(r'^trechos-de-massa-dagua/$', views.TrechoMassaDaguaList.as_view(), name='trecho_massa_dagua_list'),
    url(r'^trechos-de-massa-dagua/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.TrechoMassaDaguaList.as_view(), name='trecho_massa_dagua_list'),
    ...
    url(r'^areas-de-desenvolvimento-de-controle/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.AreaDesenvolvimentoControleList.as_view(), name='area_desenvolvimento_controle_list'),

    url(r'^marcos-de-limite/$', views.MarcoDeLimiteList.as_view(), name='marco_de_limite_list'),
    url(r'^marcos-de-limite/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.MarcoDeLimiteList.as_view(), name='marco_de_limite_list'),

    url(r'^pontos-geodesicos/$', views.PontoExibicaoWgs84List.as_view(), name='ponto_exibicao_wgs84_list'),
    url(r'^pontos-geodesicos/(?P<spatial_function>[A-Za-z]+)/(?P<geom>.*)/$', views.PontoExibicaoWgs84List.as_view(), name='ponto_exibicao_wgs84_list'),
])
